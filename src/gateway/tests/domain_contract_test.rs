use gateway::domain::{
    ...
    ErrorFrame, InferenceMetrics, PalmAction, PalmActuatePayload, PalmState, PoseName,
    ResetFaultPayload, RobotCommand, RobotState, RobotTelemetryEvent, SpawnObjectPayload,
    SpawnObjectType, TrajectoryExecutePayload, CANONICAL_UR5E_JOINTS, UR5E_JOINTS,
};
use serde_json::json;
