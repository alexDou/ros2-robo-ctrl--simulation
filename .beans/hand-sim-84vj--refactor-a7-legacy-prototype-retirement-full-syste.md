...
updated_at: 2026-09-17T22:29:02Z
...
- [ ] Deprecated directory src/edge_node/ and files completely removed
- [ ] Obsolete tests tests/test_edge_node.py and tests/test_mock_motion_publisher.py removed cleanly
- [ ] pyproject.toml and workspace configs updated with zero stale prototype references
- [ ] Non-realtime tolerance adjusted in test_robot_nodes_launch.py to pass reliably under simulated load
- [ ] Full project test suite passes 100% green:
