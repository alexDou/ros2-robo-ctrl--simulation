...
## Corpus Check
- 115 files · ~45,185 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 784 nodes · 791 edges · 85 communities (52 shown, 14 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.93)
...
- `test_robot_command_ping_serialization_round_trip()` --uses--> `CommandType`  [INFERRED]
  tests/test_domain.py → src/edge_node/domain.py
- `test_robot_telemetry_event_serialization_round_trip()` --uses--> `RobotState`  [INFERRED]
  tests/test_domain.py → src/edge_node/domain.py
...
Cohesion: 0.09
Nodes (23): autoprefixer, jsdom, oxlint, postcss, @preact/preset-vite, tailwindcss, @testing-library/preact, @types/three (+15 more)
...
Cohesion: 0.11
Nodes (18): preact, three, urdf-loader, dependencies, preact, three, urdf-loader, name (+10 more)
...
Cohesion: 0.09
Nodes (24): Error, HttpRequest, HttpResponse, Into, Option, Payload, Self, CommandType (+16 more)
...
### Community 81 - "domain.py"
Cohesion: 0.11
Nodes (29): BaseModel, Enum, CommandType, ErrorFrame, InferenceMetrics, parse_robot_topic(), Domain schemas and DataFabric topic contracts for EdgeNode., Operational lifecycle state of the robotic manipulator. (+21 more)
...
Cohesion: 0.20
Nodes (16): ArmJointPositions, CommandType, createPingCommand(), ErrorFrame, InferenceMetrics, parseErrorFrame(), parseJsonIfNeeded(), parseRobotCommand() (+8 more)
